...
const linkedInProfile = "https://www.linkedin.com/in/vladocpro/"
       ...
       <footer className=" bg-[#111111] py-2">
            <div className="Container text-white footerTextResize">
               <div className="flex justify-between  gap-1 py-2 md:py-5">
                  <section className="grid grid-cols-3  gap-3 w-[100%]">
                     <ul className="footerTitle flex flex-col gap-3 sm:gap-2">
                        <li><a className="footerLink" href={linkedInProfile}  target="_blank">Gift Cards</a></li>
                        <li><a className="footerLink" href={linkedInProfile}  target="_blank">Find a Store</a></li>
                        <li><a className="footerLink" href={linkedInProfile}  target="_blank">Nike Journal</a></li>
                        <li><a className="footerLink" href={linkedInProfile}  target="_blank">Feedback</a></li>
                     </ul>
                     <ul className="text-zinc-500 flex flex-col gap-3 sm:gap-2">
                        <li><a className="footerTitle footerLink" href={linkedInProfile} target="_blank">Get Help</a></li>
                        <li><a className="footerLink font-medium" href={linkedInProfile} target="_blank">Order Status</a></li>
                        <li><a className="footerLink font-medium" href={linkedInProfile} target="_blank">Returns</a></li>
                        <li><a className="footerLink font-medium" href={linkedInProfile} target="_blank">Contact Us</a></li>
                     </ul>
                     <ul className="text-zinc-500 flex flex-col gap-3 sm:gap-2">
                        <li><a className="footerTitle footerLink" href={linkedInProfile} target="_blank">About nike</a></li>
                        <li><a className="footerLink font-medium" href={linkedInProfile} target="_blank">News</a></li>
                        <li><a className="footerLink font-medium" href={linkedInProfile} target="_blank">Careers</a></li>
                        <li><a className="footerLink font-medium" href={linkedInProfile} target="_blank">Investors</a></li>
                     </ul>
                  </section>

                  <aside className="flex flex-col gap-1 md:gap-3 md:flex-row">
                     <a href={linkedInProfile} target="_blank">
                        <svg viewBox="0 0 24 24" fill="white" className="footerSocials">
               ...
               <div className="flex justify-between my-2 sm:my-3">
                     ...
                     <span className="text-zinc-500">© {year} Ecom, Inc. All Rights Reserved</span>
                  </div>
               </div>
       </footer>
   );
