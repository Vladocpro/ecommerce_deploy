               ...
               <div className="flex justify-between  gap-1 py-2 md:py-5">
                  <section className="grid grid-cols-3  gap-3 w-[100%]">
                     ...
                     <ul className="text-zinc-500 flex flex-col gap-3 sm:gap-2">
                        ...
                        <li><a className="footerLink font-medium" href="https://www.nike.com/gb/orders/details">Order Status</a></li>
                        <li><a className="footerLink font-medium" href="https://www.nike.com/gb/help/a/returns-policy-eu">Returns</a></li>
                        <li><a className="footerLink font-medium" href="https://www.nike.com/gb/help/#contact">Contact Us</a></li>
                     </ul>
                     <ul className="text-zinc-500 flex flex-col gap-3 sm:gap-2">
                        <li><a className="footerTitle footerLink" href="https://about.nike.com/">About nike</a></li>
                        <li><a className="footerLink font-medium" href="https://news.nike.com/">News</a></li>
                        <li><a className="footerLink font-medium" href="https://jobs.nike.com/">Careers</a></li>
                        <li><a className="footerLink font-medium" href="https://investors.nike.com/">Investors</a></li>
                     </ul>
                  </section>
