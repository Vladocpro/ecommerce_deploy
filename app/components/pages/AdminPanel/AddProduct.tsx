   ...
   return (
       <div className="flex flex-col gap-5">
          <input
              ...
              value={name}
              className={`mt-6 p-2 h-12 outline-black  rounded-lg border-[1.75px] border-gray-300`}
          ...
          <div>
             ...
             <form method="post" onSubmit={handleOnSubmit} onChange={handleOnChange}>
                ...
                <button
                    className="py-3 w-full mx-auto rounded-lg bg-black text-white font-bold mb-10 mt-4">{uploading ? "Uploading..." : "Add Product"}</button>
