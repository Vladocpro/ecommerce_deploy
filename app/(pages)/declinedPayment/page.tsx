...
const HOME = () => {
   return (
       <div className="flex flex-col justify-center items-center text-[#ff0000] h-full text-2xl">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0,0,256,256" width="64px" height="64px" fillRule="nonzero">
             <g fill="#ff0000" fillRule="nonzero" stroke="none" strokeWidth="1" strokeLinecap="butt" strokeLinejoin="miter" strokeMiterlimit="10" strokeDashoffset="0"><g transform="scale(2,2)">
             ...
             <span>Payment was declined</span>
          <Link href="/" className="mt-3 text-2xl px-7 py-1 border-[2px] text-black border-black hover:bg-black hover:text-white transition-all duration-300">Go Home</Link>
